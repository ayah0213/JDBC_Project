    ...
    public static void main(String[] args) {
      ...
      //  DB_Utility.displayAllData();
        ...
        System.out.println("DB_Utility.getRowDataAsList(2) =  \n\t"
                + DB_Utility.getRowDataAsList(2));

        System.out.println("DB_Utility.getCEllValue(8,5) =  \n\t"
                + DB_Utility.getCEllValue(8,5));

        System.out.println("DB_Utility.getCEllValue(8,\"Phone\") = \n\t "
                + DB_Utility.getCEllValue(8,"PHONE_NUMBER"));

        System.out.println("DB_Utility.getColumnDataAsList(5) =  \n\t"
                + DB_Utility.getColumnDataAsList(5));

        System.out.println("DB_Utility.getColumnDataAsList(\"PHONE_NUMBER\") =  \n\t"
                + DB_Utility.getColumnDataAsList("PHONE_NUMBER"));
